...
<div class="wrap-body">
	...
	<div class="site-title">
		<div class="zerogrid">
			<div class="row">
				<h2 class="t-center">Inivitado</h2>
			</div>
		</div>
	</div>
    <!--//////////////////////////////////////Menu-->
		...
		<section class="content-box box-1">
			<div class="zerogrid">
				<div class="row box-item"><!--Start Box-->
					<h2>“Le ofrecemos la mejor pizza de San Carlos”</h2>
					<span>Ven y disfruta de la mejor y deleciosa pizza con nosotros</span>
				</div>
			</div>
		</section>
		<!-----------------content-box-2-------------------->
			...
			<div class="zerogrid">
				<div class="row wrap-box"><!--Start Box-->
					<div class="header">
						<h2>Bienvenido</h2>
						<hr class="line">
						<span>Pizza Ranch te da la bienvenida a la mejor pizzería</span>
					</div>
					<div class="row">
						<div class="col-1-3">
							<div class="wrap-col">
