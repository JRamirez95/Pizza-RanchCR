...
<section id="container" class="sub-page">
	<div class="wrap-container zerogrid">
        <div class="crumbs">
			<h2 class="t-center">Golosinas</h2>
		</div>
		<div id="main-content">
			<div class="wrap-content col-12">
				<?php foreach ($golosinas as $index=> $golosina){ ?>
                    ...
                    <div class="col-1-4 ">
                        <div class="card bg-light mb-3">
                            <div class="card-body col-12 "><br>
                                <a href="">
                                    <center><img class="img-fluid" src="<?php echo $golosina->foto; ?>" width="200px" height="200px"/></center>
                                </a>
                            
							<form method="get" action=""><br>
							<center><h3><strong><?php echo $golosina->nombre; ?></strong></h3></center>
							<div>
							<label for="price"><strong>Precio:</strong></label>
                                <p class="price">₡ <?php echo $golosina->precio; ?></p>
