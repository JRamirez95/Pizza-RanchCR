	                    ...
	                    <div class="col-1-4 ">
	                        <div class="card bg-light mb-3">
	                            <div class="card-body col-12 "><br>
	                                <a href="">
	                                    <center><img class="img-fluid" src="<?php echo $pizza->foto; ?>" width="200px" height="200px"/></center>
	                                </a>

								<form method="get" action=""><br>
								<center><h3><strong><?php echo $pizza->nombre; ?></strong></h3></center>
								...
								<label for="price"><strong>Precio:</strong></label>
	                                <p class="price">₡ <?php echo $pizza->precio; ?></p>
