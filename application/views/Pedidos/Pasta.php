...
<section id="container" class="sub-page">
	<div class="wrap-container zerogrid">
        <div class="crumbs">
			<h2 class="t-center">Pastas</h2>
		</div>
		<div id="main-content">
			<div class="wrap-content col-12">
				<?php foreach ($pastas as $index=> $pasta){ ?>
                    ...
                    <div class="col-1-4 ">
                        <div class="card bg-light mb-3">
                            <div class="card-body col-12 "><br>
                                <a href="">
                                    <center><img class="img-fluid" src="<?php echo $pasta->foto; ?>" width="200px" height="200px"/></center>
                                </a>

							<form method="get" action=""><br>
							<center><h3><strong><?php echo $pasta->nombre; ?></strong></h3></center>
							<a href="#"class="btn btn-default btn-sm btn-block "  onclick="cargarModal()">
							...
							<label for="price"><strong>Precio:</strong></label>
                                <p class="price">₡ <?php echo $pasta->precio; ?></p>
...
function cargarModal()
{
 $id = $pasta->id;
 $tabla = "pasta";
 $modal = $this->Ranch_model->cargarModal($id, $tabla);

 $modal = <?php echo "<p>"?><?php $this->descripcion ?>" </p><br>"; ?>
}
</script>
