...
<section id="container" class="sub-page">
    <div class="wrap-container zerogrid">
        <div class="crumbs">
            <h2 class="t-center">Calzone</h2>
        </div>
        <div id="main-content">
            <div class="wrap-content col-12">
                <?php
foreach ($calzones as $index => $calzone) {
?>
                    ...
                    <div class="col-1-4 ">
                        <div class="card bg-light mb-3">
                            <div class="card-body col-12 "><br>
                                <a href="">
                                    <center><img class="img-fluid" src="<?php
    echo $calzone->foto;
?>" width="200px" height="200px"/></center>
    ...
    echo $calzone->nombre;
?></strong></h3></center>
                            <a href="cart.html" class="btn btn-default btn-sm btn-block " data-toggle="modal" data-target="#detalle">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-12">
               	 <center><p><?php echo $calzone->descripcion;?></p></center>
				</div>
			</div>
		</div>
	</div>
