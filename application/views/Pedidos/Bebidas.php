				...
				<?php foreach ($bebidas as $index=> $bebida){ ?>
                    ...
                    <div class="col-1-4 ">
                        <div class="card bg-light mb-3">
                            <div class="card-body col-12 "><br>
                                <a href="">
                                    <center><img class="img-fluid" src="<?php echo $bebida->foto; ?>" width="200px" height="200px"/></center>
                                </a>

							<form method="post" action=""><br>
							<center><h3><strong><?php echo $bebida->nombre; ?></strong></h3></center>
							<center><h5><?php echo $bebida->medida; ?></h5></center><hr>
							<div>
							...
							<br>
                                    <div class="form-group">
                                        ...
                                        <select class="btn-sm" name="cantidad" id="cantidad">
                    ...
                    <?php
                     ...
                     ?>
								...
								<a href="Home/agregarCarrito()" type="submit" class="btn btn-success btn-ms btn-block text-uppercase" >
